...
*You might be wondering:* "_How can billions of weights be learned automatically? What does 'learned, not programmed' mean in practice?_"
...
*You might be wondering:* "_Why doesn't adding the input back (x + layer(x)) mess up what the layer learned?_"
