...
*You might be wondering:* "_Why do high dimensions make patterns separable? The 2D→3D example is intuitive, but why does adding thousands of dimensions help?_"
...
*You might be wondering:* "_What does 'sort of' mean? Does the model understand or not?_"
...
*You might be wondering:* "_If hallucinations come from pattern matching, why can't we add fact-checking to prevent them?_"
...
xref:16-appendix.adoc[Next: Appendix — Where to Go Next →]
