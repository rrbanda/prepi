...
:description: Understanding what LLMs actually do - they predict, they don't know
...
*You might be wondering:* "_If the model only predicts the next word, how does it 'understand'? Isn't it just pattern matching?_"
...
*You might be wondering:* "_But pattern matching sounds simple. How does that produce essays and code?_"
...
_If I asked you to complete "The cat sat on the ___," you'd probably say "mat" or "floor" or "couch."_
...
xref:02-the-language-barrier.adoc[Next: The Language Barrier →]
